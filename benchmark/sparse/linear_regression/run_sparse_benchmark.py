...
# profiler.set_config(profile_all=True, aggregate_stats=True, filename='profile_output_K_MX_sparse.json')
...
def invoke_benchmark(batch_size, epochs):
    ...
    keras_sparse_model.run_benchmark(train_data=sparse.csr_matrix(t_data),
                                     #train_label=sparse.csr_matrix(train_label.asnumpy()),
                                     train_label=train_label.asnumpy(),
                                     eval_data=sparse.csr_matrix(e_data),
